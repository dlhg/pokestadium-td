  ...
  },
  {
    ...
    routes:[
      [
        ...
        [-18,3],[-11,4],[-5,7],[-10,9],[-18,8],[-23,4],
        [-25,0,TIER_SILVER_PINE],[-25,-6,TIER_SILVER_BALCONY],
        [-19,-7],[-12,-6],[-5,-4],[-9,-1],[-16,-1],[-22,-4],[-24,-8],
        [-24,-11,TIER_SILVER_BALCONY],[-21,-17,TIER_SILVER_SADDLE],
        [-15,-18],[-8,-17],[-3,-14],[-7,-12],[-14,-13],[-19,-16],
        [-15,-21,TIER_SILVER_SADDLE],[-9,-26,TIER_SILVER_CROWN],
        [-2,-24],[5,-24],[10,-27],[6,-29],[0,-29],
      ],
      [
        [29,19],[25,24],[17,27],[9,24],[12,18],[19,15],
        [24,11,0],[24,5,TIER_SILVER_PINE],
    ...
    obstacles:[
      ...
      { x:0,z:-4.8,radius:1.5,label:'Balcony ridge',style:'boulder' },
