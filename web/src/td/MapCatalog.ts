...
export type ObstacleStyle = 'rock' | 'tree' | 'single-tree' | 'generator' | 'pine' | 'boulder' | 'pillar' | 'brick' | 'center';
...
export const STADIUM_MAPS: StadiumMap[] = [
  {
    ...
    obstacles: [
      { x:-14, z:-15, radius:2.7, label:'Viridian tree', style:'single-tree' },
      { x:-10, z:3, radius:2.5, label:'Mossy rocks', style:'rock' },
      { x:14, z:-4, radius:2.8, label:'Viridian tree', style:'single-tree' },
      { x:-3, z:23, radius:3, label:'Garden boulders', style:'rock' },
      { x:6, z:-23, radius:2.5, label:'Viridian tree', style:'single-tree' },
    ], water: [], bridges: [],
  },
  {
