...
`func_84302658` in src/fragments/62 DMAs a 0xB90-byte table per species. This
Rev 2 adaptation reads it at 0x70E6B0 through the pointer table at ROM 0x76910.
It is an
